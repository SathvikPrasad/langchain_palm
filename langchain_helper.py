...
vectordb_file_path = "faiss_index20"

# assets folder and file name
assets_directory = Path("assets")
file_name = "XNew.csv"
file_path = assets_directory / file_name

def create_vector_db():
    print(vectordb_file_path)
...
def get_qa_chain():
    ...
    # If the answer is not found in the context, respond normally.
    
    prompt_template = """Your name is X and your a consulting company which helps students to apply to colleges and helps in F1 visa processing. 
